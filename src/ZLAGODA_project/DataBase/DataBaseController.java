...
public class DataBaseController {
    ...
    public Connection connect() {
        String url = "jdbc:sqlite:db/" + this._nameOfDB + ".db";
        Connection conn = null;
        try {
            //conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/zlagoda","root","Qwerty123");
    ...
    public static void main(String[] args) {
        ...
        System.out.println(sha256("Qwerty123"));
